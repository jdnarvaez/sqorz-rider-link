...
const Form = () => {
    ...
    const [weekendRaceID, setWeekendRaceID] = useState(localStorage.getItem('weekendRaceID') || '');
    ...
    return (
      <div className="appForm">
        <div className="formInput">
          ...
          <input id="raceId" type="url" placeholder="Race ID" value={raceID} onChange={(e) => { setRaceID(e.target.value); localStorage.setItem('raceID', e.target.value) }} />
        </div>

        <div className="formInput">
          <label for="weekendRaceId">Weekend Race ID</label>
          <input type="url" id="weekendRaceId" placeholder="Weekend Race ID" value={weekendRaceID} onChange={(e) => { setWeekendRaceID(e.target.value); localStorage.setItem('weekendRaceID', e.target.value) }} />
        </div>
        ...
        <div className="formInput">
          ...
          <div className="inputGroup">
            ...
            <input type="text" id="riderCSVFile" placeholder="Rider CSV File" value={riderCSVFile} onChange={(e) => { setRiderCSVFile(e.target.value); localStorage.setItem('riderCSVFile', e.target.value) }} />
          </div>
        </div>
        ...
        <div className="formInput">
          ...
          <div className="inputGroup">
            ...
            <input type="text" id="outputFile" placeholder="Output JSON Directory" value={outputFile} onChange={(e) => { setOutputFile(e.target.value); localStorage.setItem('outputFile', e.target.value) }} />
          </div>
        </div>
